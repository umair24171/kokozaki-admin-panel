...
class SuperMarkets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: FutureBuilder(
          future: marketsController.getSuperMarkets(),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${marketsController.superMarkets.length}',
                    ...
                    child: Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: DataTable(
                            ...
                            rows: List.generate(
                                marketsController.superMarkets.length, (index) {
                              MarketModel marketModel =
                                  marketsController.superMarkets[index];
